import log from '../../../assets/images/Rectangle9.png';
    ...
    return (
        <div className="md:px-14 p-4 mt-28 max-w-screen-2xl mx-auto py-10 bg-[#010851] rounded-xl text-white">
            <div className="my-12 flex flex-col md:flex-row gap-10">
                <div className="md:w-1/2 space-y-8">
                    <a href="/" className='text-2xl font-semibold flex items-center space-x-3 text-primary'>
                        <img src={log} alt="" className='w-10 inline-block items-center' /> <span className='text-white'>XYZ</span>
                    </a>
                ...
                {/* footer navigations */}
                <div className="md:w-full md:pr-24 pr-0 flex flex-col md:flex-row flex-wrap justify-between gap-8 items-start">
            ...
            <div className="flex flex-col sm:flex-row gap-8
             justify-between sm:items-center my-8">
                <p>@ XYZ 20XX --- 20XX. All rights reserved.</p>
                <div className=" flex items-center space-x-5">
                    <img src={icon1} alt="" className='w-8 cursor-pointer hover:translate-y-4 transition-all duration-300' />
                    <img src={icon2} alt="" className='w-8 cursor-pointer hover:translate-y-4 transition-all duration-300' />
                    <img src={icon3} alt="" className='w-8 cursor-pointer hover:translate-y-4 transition-all duration-300' />
                    <img src={icon4} alt="" className='w-8 cursor-pointer hover:translate-y-4 transition-all duration-300' />
                </div>
            </div>
        </div>
    );
